...
echo "Starting load..."
java -jar /controller/loadgenerator/httploadgenerator.jar director --ip 10.100.25.158 --load /controller/teastore/loads/increasingHighIntensity.csv -o testlog.csv --lua /controller/teastore/loads/teastore_browse.lua
