...
java -jar /controller/httploadgenerator.jar director --ip localhost --load /controller/teastore/loads/LowLoad5.csv -o testlog.csv --lua /controller/teastore/loads/teastore_browse.lua --timeout=3000
